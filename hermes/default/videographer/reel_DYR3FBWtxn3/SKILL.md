---
name: reel_DYR3FBWtxn3
description: "Reel technique from Instagram — raw vs log from @unknown"
version: 1.0.0
author: Hermes Agent
metadata:
  hermes:
    tags: [videographer, reel, raw-vs-log, davinci-resolve, color-grading]
---

# raw vs log — Reel Technique

> **Source:** [Instagram Reel](https://www.instagram.com/reel/DYR3FBWtxn3/)
> **Creator:** @unknown
> **Date Processed:** 2026-07-18
> **Instagram Post Code:** DYR3FBWtxn3
> **Content Type:** Reel
> **Technique Category:** Camera Theory & Color Science / raw vs log
...
|-----------|-------|---------|
| Shot Type | raw vs log | Core technique |
