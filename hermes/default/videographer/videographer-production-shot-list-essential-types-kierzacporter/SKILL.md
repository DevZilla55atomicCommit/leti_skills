---
name: videographer-production-shot-list-essential-types-kierzacporter
description: "Production: 9 Essential Shot Types for Universal Scene Coverage — Wide, Medium, Close Up, Detail, B-Roll, Action, POV, Establishing, Transition from @kierzacporter"
version: 1.0.0
author: Hermes Agent
metadata:
  hermes:
    tags: [production, shotlist, pre-production, cinematography, shot-types, wide-shot, medium-shot, close-up, detail-shot, broll, action-shot, pov-shot, establishing-shot, transition-shot, visual-storytelling, scene-coverage, film-school, director-tools]
---

# 9 Essential Shot Types — Production Technique

> **Source:** [@kierzacporter — An easy to follow shot list for any video](https://www.instagram.com/p/DE7bo_xCzZc/)
> **Creator:** @kierzacporter (Verified)
> **Date Processed:** 2025-07-18
> **Instagram Post Code:** DE7bo_xCzZc
> **Content Type:** Carousel Post (9 slides)
> **Technique Category:** Production / Shot List / Pre-Production

---

## 🎯 Technique Summary

Complete 9-shot framework for any video production. Covers essential building blocks of visual storytelling plus 2 bonus shots for professional polish. Universal template applicable to narrative, commercial, documentary, and social content.

---

## 📋 Complete Shot List

| # | Shot Type | Purpose | Lens | Key Settings |
|---|-----------|---------|------|--------------|
...
| 8 | **Establishing Wide (Bonus)** | Re-establishes geography after sequences | 16-24mm | Same as #1, different angle/time |
| 9 | **Transition Shot (Bonus)** | Seamless scene changes | Any | Match action/direction/color |
...
V8: Re-Establishing Wide (post-sequence)
V9: Transition Element (match cut)
...
- [ ] Re-Establishing: New angle/time shows progression
- [ ] Transition: Match action/direction/color for seamless flow
...
`#videographer` `#production` `#shotlist` `#pre-production` `#cinematography` `#shot-types` `#wide-shot` `#medium-shot` `#close-up` `#detail-shot` `#broll` `#action-shot` `#pov-shot` `#establishing-shot` `#transition-shot` `#visual-storytelling` `#scene-coverage` `#film-school` `#director-tools`
