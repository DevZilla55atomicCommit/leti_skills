...
| Hermes Agent integration | `references/hermes-integration.md` |
| **Obsidian vault sync** | `references/obsidian-vault-sync-patterns.md` |
| **Compression tuning for reasoning chains** | `references/compression-tuning.md` |
...
- See configuration guidance in `references/config-tips.md`.
