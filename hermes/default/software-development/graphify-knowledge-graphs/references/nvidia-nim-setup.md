...
| Model ID | Params | Quality | Speed | Use Case |
|----------|--------|---------|-------|----------|
| `nvidia/nemotron-3-ultra-550b-a55b` | 550B MoE | ⭐⭐⭐ Best | Slow | Production graphs, complex extraction |
| `nvidia/nemotron-3-super-120b-a12b` | 120B MoE | ⭐⭐ Great | Medium | Balanced quality/speed |
| `nvidia/llama-3.1-nemotron-70b-instruct` | 70B | ⭐⭐ Good | Fast | Quick iteration |
| `meta/llama-3.1-70b-instruct` | 70B | ⭐⭐ Good | Fast | General purpose |
