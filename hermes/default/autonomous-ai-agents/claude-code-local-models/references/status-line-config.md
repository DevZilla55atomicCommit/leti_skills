...
LINE1="${CYAN}[$MODEL]${RESET} 📁 ${DIR_NAME}${GIT_STATUS}${ENV_HINT} | ${PCT}% context $CIRCLE${WARNING_INDICATOR} 💾 ${OPS_ICON} | ${RAM_ICON} | ${TPS_NUM_BLINK}${TPS_NUM_COLOR}${TPS_FMT}${RESET} ${TPS_ICON_COLOR}${TPS_ICON}${RESET}"
