---
name: davinci-video-effect-C-p1BGkJ
description: |
  DaVinci Resolve video effect technique extracted from Instagram Reel C-p1BGkJFnm
  Collection: Video Effects
  Source: https://www.instagram.com/reel/C-p1BGkJFnm/
...
references:
  - "instagram_reel_id": "C-p1BGkJFnm"
  - "source_url": "https://www.instagram.com/reel/C-p1BGkJFnm/"
  - "collection": "Video Effects"
  - "analyzed_at": "2026-07-25T15:58:39.903224"
---

# davinci-video-effect-C-p1BGkJ

## Overview
This skill captures the video effect technique demonstrated in Instagram Reel `C-p1BGkJFnm` from the **Video Effects** collection.
...
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-p1BGkJFnm/
- **Analyzed:** 2026-07-25T15:58:39.903230
- **Frames Analyzed:** 3
...
- `frames/` - Keyframes at 0s, 9.5s, 19s
- `gifs/` - 5s preview GIF
- `~/.hermes/skills/creative/davinci-video-effect-C-p1BGkJ/SKILL.md` - Full Hermes skill
- `~/.hermes/skills/creative/davinci-video-effect-C-p1BGkJ/QUICK_REF.md` - Quick reference card

## Metadata
- **Reel ID:** C-p1BGkJFnm
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-p1BGkJFnm/
- **Analyzed:** 2026-07-25T15:58:39.903232
- **Frames Analyzed:** 3
- **Educational Value:** High educational value
