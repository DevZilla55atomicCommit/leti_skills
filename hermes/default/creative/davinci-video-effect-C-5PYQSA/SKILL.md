---
name: davinci-video-effect-C-5PYQSA
description: |
  DaVinci Resolve video effect technique extracted from Instagram Reel C-5PYQSADOG
  Collection: Video Effects
  Source: https://www.instagram.com/reel/C-5PYQSADOG/
...
references:
  - "instagram_reel_id": "C-5PYQSADOG"
  - "source_url": "https://www.instagram.com/reel/C-5PYQSADOG/"
  - "collection": "Video Effects"
  - "analyzed_at": "2026-07-25T15:55:34.056094"
---

# davinci-video-effect-C-5PYQSA

## Overview
This skill captures the video effect technique demonstrated in Instagram Reel `C-5PYQSADOG` from the **Video Effects** collection.
...
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-5PYQSADOG/
- **Analyzed:** 2026-07-25T15:55:34.056100
- **Frames Analyzed:** 3
...
- `frames/` - Keyframes at 0s, 9.5s, 19s
- `gifs/` - 5s preview GIF
- `~/.hermes/skills/creative/davinci-video-effect-C-5PYQSA/SKILL.md` - Full Hermes skill
- `~/.hermes/skills/creative/davinci-video-effect-C-5PYQSA/QUICK_REF.md` - Quick reference card

## Metadata
- **Reel ID:** C-5PYQSADOG
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-5PYQSADOG/
- **Analyzed:** 2026-07-25T15:55:34.056102
- **Frames Analyzed:** 3
- **Educational Value:** High educational value
