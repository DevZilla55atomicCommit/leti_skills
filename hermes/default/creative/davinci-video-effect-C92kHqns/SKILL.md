---
name: davinci-video-effect-C92kHqns
description: |
  DaVinci Resolve video effect technique extracted from Instagram Reel C92kHqns4-x
...
references:
  ...
  - "collection": "Video Effects"
  - "analyzed_at": "2026-07-25T15:56:33.405056"
---

# davinci-video-effect-C92kHqns

## Overview
This skill captures the video effect technique demonstrated in Instagram Reel `C92kHqns4-x` from the **Video Effects** collection.
...
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C92kHqns4-x/
- **Analyzed:** 2026-07-25T15:56:33.405061
- **Frames Analyzed:** 3
...
- `frames/` - Keyframes at 0s, 9.5s, 19s
- `gifs/` - 5s preview GIF
- `~/.hermes/skills/creative/davinci-video-effect-C92kHqns/SKILL.md` - Full Hermes skill
- `~/.hermes/skills/creative/davinci-video-effect-C92kHqns/QUICK_REF.md` - Quick reference card

## Metadata
- **Reel ID:** C92kHqns4-x
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C92kHqns4-x/
- **Analyzed:** 2026-07-25T15:56:33.405063
- **Frames Analyzed:** 3
- **Educational Value:** High educational value
