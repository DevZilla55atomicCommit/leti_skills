---
name: davinci-video-effect-C-VrnueO
description: |
  DaVinci Resolve video effect technique extracted from Instagram Reel C-VrnueOdX1
  Collection: Video Effects
  Source: https://www.instagram.com/reel/C-VrnueOdX1/
  Educational focus: Video editing technique
version: 1.0.0
category: creative
tags:
  - davinci-resolve
...
references:
  ...
  - "collection": "Video Effects"
  - "analyzed_at": "2026-07-25T15:53:29.006022"
---

# davinci-video-effect-C-VrnueO

## Overview
This skill captures the video effect technique demonstrated in Instagram Reel `C-VrnueOdX1` from the **Video Effects** collection.
...
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-VrnueOdX1/
- **Analyzed:** 2026-07-25T15:53:29.006028
- **Frames Analyzed:** 3
- **Educational Value:** High educational value

## Files Generated
- `vision_report.json` - Full frame-by-frame analysis
- `frames/` - Keyframes at 0s, 9.5s, 19s
- `gifs/` - 5s preview GIF
- `~/.hermes/skills/creative/davinci-video-effect-C-VrnueO/SKILL.md` - Full Hermes skill
- `~/.hermes/skills/creative/davinci-video-effect-C-VrnueO/QUICK_REF.md` - Quick reference card

## Metadata
- **Reel ID:** C-VrnueOdX1
- **Collection:** Video Effects
- **Source:** https://www.instagram.com/reel/C-VrnueOdX1/
- **Analyzed:** 2026-07-25T15:53:29.006030
- **Frames Analyzed:** 3
- **Educational Value:** High educational value
