---
name: family-tree-app-improvement
title: Family Tree App Improvement Plan (Kasini)
description: Comprehensive technical and cultural blueprint for building a Tongan family tree app (Kasini). Built for Pacific heritage communities.
authors: [maddie]
created: 2026-07-12
---

# Family Tree App Improvement Plan (Kasini) — Streamlined Core Plan
